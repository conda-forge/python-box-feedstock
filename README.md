...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/python-box-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-box-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install python-box
```
...
It is possible to list all of the versions of `python-box` available on your platform:
...
```
pixi search python-box --channel conda-forge
```
